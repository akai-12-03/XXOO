 ...
 */
@Controller
public class WebAppLoanAuthorizeController extends WebController{
	 ...
	 * 生成授权信息
	 */
	@RequestMapping("webapp/qddApi/loanAuthorize")
...
//				SubmitURL="http://222.92.117.57/loan/toloanauthorize.action";
			...
			ReturnURL = Global.getValue("qdd_notifyUrl") + "/webapp/qddApi/authorizeReturn.html";
			NotifyURL = Global.getValue("qdd_notifyUrl") + "/webapp/qddApi/authorizeNotify.html";
...
//			MD5 md5 = new MD5();
	 ...
	 * @return
	 */
	@RequestMapping("webapp/qddApi/authorizeReturn")
...
//		MD5 md5 = new MD5();
	 ...
	 * @return
	 */
	@RequestMapping("webapp/qddApi/authorizeNotify")
