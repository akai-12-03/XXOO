 ...
 */
@Controller
public class webAppPayController extends WebController {
...
//	@Qualifier("defaultPayService")//默认支付
	 ...
	 * @throws IOException
	 */
	@RequestMapping("webapp/myhome/payCharge")
...
//				request.setAttribute("user", user);
			...
			try {
				...
				String p8_Url           = web_Url+"/webapp/pay/yeepay_notify.html";
				String p9_SAF           = "0";
				String pa_MP            = "";
	 ...
	 * @throws
	 */
    @RequestMapping("webapp/pay/yeepay_notify")
                ...
                if(r1_Code.equals("1")) {
                    ...
                    //成功的流程
                        ...
                        if(r9_BType.equals("2")){ //表示是notify
                            ...
                            return "redirect:/webapp/user-index.html";
                        }
