...
@Controller
public class WebAppToloanwithdrawsController extends WebController {
	
	private static final Logger LOGGER=Logger.getLogger(WebAppToloanwithdrawsController.class);
	 ...
	 * 生成提现信息
	 */
	@RequestMapping("webapp/qddApi/toloanwithdraws")
	 ...
	 * @return
	 */
	@RequestMapping("webapp/qddApi/toloanwithdrawsRechargeReturn")
...
//		MD5 md5 = new MD5();
	 ...
	 * @return
	 */
	@RequestMapping("webapp/qddApi/toloanwithdrawsNotify")
