...
import com.dept.web.dao.model.pay.YeepayQueryResult;
import com.dept.web.dao.model.pay.YeepayRefundResult;


public class PaymentForOnlineService {
	
	private static Log log 					= LogFactory.getLog(PaymentForOnlineService.class);
	private static String p1_MerId 			= "10012521423"; 			// 商家ID //正式商户号
	...
	private static String keyValue 			= "48z4rjo6z50pcgqi18nnwjp2spu90ipvmcpgqkbiwh87tk342iprw7b5p3jp";	//正式商家密钥	// 商家密钥
	 ...
	 * @return queryResult
	 */
	public static YeepayQueryResult queryByOrder(String p2_Order) {
		
	    YeepayQueryResult qr = null;
	 ...
	 * @return refundResult
	 */
	public static YeepayRefundResult refundByTrxId(String pb_TrxId,String p3_Amt,String p4_Cur,String p5_Desc) {
	    YeepayRefundResult rr = null;
