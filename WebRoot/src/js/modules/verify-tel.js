...
define(function(require, exports, module){
	...
	VerifyTel.prototype = {
		...
		setConfig: function(option){
			...
			// params = params || {};
			// this.params.telphone = params.target || this.container.data('target') || '#telphone';
			// this.params.username = params.username || this.container.data('username') || '#username';
			// this.params.totalTime = params.totalTime || 60;
			// this.params.type = params.type || 'normal';
			
			this.params = $.extend(true, {}, defaultOption, option);
			this.params.url = option.url || '/sendcode.html';
		...
		_alert: function(msg){
			...
			if(tip.length > 0){
				...
				alert(msg);
				warn('Can not find notice container.', 'at input.verifytel-box');
			}
			return this;
		},
		...
		sendCode: function(){
			...
			var $this = this;
			// console.log($this.params, $this.params.telphone);

			var $telphoneInput = $($this.params.telphone);
			// console.log($telphoneInput);
